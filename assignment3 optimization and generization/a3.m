...
function ret = d_loss_by_d_model(model, data, wd_coefficient)
  ...
  % The returned object is supposed to be exactly like parameter <model>, i.e. it has fields ret.input_to_hid
  %and ret.hid_to_class. However, the contents of those matrices are gradients (d loss by d model parameter), instead of model parameters.
...
%  for i=1:2
% for j=1:7
% a3(0, 10, 70, a(j), b(i), false, 4) ,a(j),b(i)
% pause
% end
% end
